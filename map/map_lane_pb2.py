...
_LANE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='junction', full_name='apollo.hdmap.Lane.junction', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='left_sample', full_name='apollo.hdmap.Lane.left_sample', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='right_sample', full_name='apollo.hdmap.Lane.right_sample', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='direction', full_name='apollo.hdmap.Lane.direction', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='left_road_sample', full_name='apollo.hdmap.Lane.left_road_sample', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='right_road_sample', full_name='apollo.hdmap.Lane.right_road_sample', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='junctionOverlapGroup', full_name='apollo.hdmap.Lane.junctionOverlapGroup', index=22,
...
_JUNCTIONOVERLAPGROUP = _descriptor.Descriptor(
  name='JunctionOverlapGroup',
  full_name='apollo.hdmap.JunctionOverlapGroup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='junctionReference', full_name='apollo.hdmap.JunctionOverlapGroup.junctionReference', index=0,
...
_JUNCTIONREFERENCE = _descriptor.Descriptor(
  name='JunctionReference',
  full_name='apollo.hdmap.JunctionReference',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='apollo.hdmap.JunctionReference.id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='startOffset', full_name='apollo.hdmap.JunctionReference.startOffset', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='endOffset', full_name='apollo.hdmap.JunctionReference.endOffset', index=2,
...
_LANE.fields_by_name['junction'].message_type = map__id__pb2._ID
...
_LANE.fields_by_name['junctionOverlapGroup'].message_type = _JUNCTIONOVERLAPGROUP
_LANE_LANETYPE.containing_type = _LANE
_LANE_LANETURN.containing_type = _LANE
_LANE_LANEDIRECTION.containing_type = _LANE
_JUNCTIONOVERLAPGROUP.fields_by_name['junctionReference'].message_type = _JUNCTIONREFERENCE
_JUNCTIONREFERENCE.fields_by_name['id'].message_type = map__id__pb2._ID
...
DESCRIPTOR.message_types_by_name['JunctionOverlapGroup'] = _JUNCTIONOVERLAPGROUP
DESCRIPTOR.message_types_by_name['JunctionReference'] = _JUNCTIONREFERENCE
...
JunctionOverlapGroup = _reflection.GeneratedProtocolMessageType('JunctionOverlapGroup', (_message.Message,), dict(
  DESCRIPTOR = _JUNCTIONOVERLAPGROUP,
  __module__ = 'map_lane_pb2'
  # @@protoc_insertion_point(class_scope:apollo.hdmap.JunctionOverlapGroup)
  ))
_sym_db.RegisterMessage(JunctionOverlapGroup)

JunctionReference = _reflection.GeneratedProtocolMessageType('JunctionReference', (_message.Message,), dict(
  DESCRIPTOR = _JUNCTIONREFERENCE,
  __module__ = 'map_lane_pb2'
  # @@protoc_insertion_point(class_scope:apollo.hdmap.JunctionReference)
  ))
_sym_db.RegisterMessage(JunctionReference)
